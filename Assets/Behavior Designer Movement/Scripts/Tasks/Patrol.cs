...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class Patrol : NavMeshMovement
    {
        ...
        public SharedFloat minWaypointPauseDuration = 0;
        public SharedFloat maxWaypointPauseDuration = 0;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (HasArrived()) {
                ...
                //Setting random value for waypoint pause
                float waypointPauseDuration = Random.Range(minWaypointPauseDuration.Value, maxWaypointPauseDuration.Value);
        ...
        public override void OnReset()
        {
            ...
            randomPatrol = false;
            minWaypointPauseDuration.Value = 0;
            maxWaypointPauseDuration.Value = 0;
            waypoints = null;
        }
